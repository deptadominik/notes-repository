...
describe('User is able to add a note with default title to default directory', () => {
  before(() => {
    cy.request('POST', 'http://localhost:8000/api/accounts/empty', { email: "note@1.com", password: 'Admin123!'})
  ...
  after(() => {
    cy.request('DELETE', 'http://localhost:8000/api/accounts/delete-by-email/', { email: 'note@1.com'})
  })
})
